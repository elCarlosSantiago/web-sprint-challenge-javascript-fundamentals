...
// Nested function can access the thanks to the beauty of closures! nestedFunction is a child function of myFunction where the const internal is declared.
// This means that internal lives within the scope of myFunction. Due to their parent-child relationship, nestedFunction can reach out thru closure and access
// the variable.
...
function USApop(arr) {
    const newArr = arr.reduce((pop, obj) => {
        return pop + obj.population;
    }, 0)
    return newArr;
}
...
//🦄🦄🦄 Test your volume and surfaceArea methods by uncommenting the logs below: 🦄🦄🦄
// console.log('heylookyhere', cuboidTwo.volume()); // 100
